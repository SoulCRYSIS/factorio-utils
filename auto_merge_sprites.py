...
def find_split_layout(frame_count, width, height, is_one_row):
    """
    ...
    if is_one_row:
        ...
        full_cols = get_columns(frame_count)
...
def process_component(component, prefix, destination, is_plant=False, is_one_row=False, frame_size=None):
    ...
    split_result = find_split_layout(frame_count, width, height, is_one_row)
...
def main(prefix, destination, include_object=True, include_shadow=True, include_reflection=True, include_glow=True, is_plant=False, is_one_row=False, frame_size=None):
    """
    ...
    for component in components:
        try:
            process_component(component, prefix, destination, is_plant, is_one_row, frame_size)
